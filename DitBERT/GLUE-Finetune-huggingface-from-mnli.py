...
# %%
run_id = "run-Bert-05-mnli"
# run_id = "run-RoBERTa-08-mnli"

# %%
# Set input and output paths
input_path = pathlib.Path("Output")

# model_path = pathlib.Path("GLUE-Outputs/run-RoBERTa-01/model_mnli.pth")
model_path = pathlib.Path("GLUE-Outputs/run-Bert-01/model_mnli.pth")
...
for glue_task in run_glue_tasks:
    ...
    class BERT_Classifier(nn.Module):
        def __init__(self, num_classes, dropout_rate=0.1):
            ...
            self.base_model = mnli_model.base_model
